...
void help() // Prints supported functionalities
{
	std::cout << "\nThe following commands are supported:\n\n"
				 ...
				 " -frees memory\n"
				 "save\n"
				 " -saves original object to origin file\n"
				 "saveas <file>\n"
				 " -saves original object to <file>\n"
				 "saveelement <JSONPath>\n"
				 " -saves result of <JSONPath> evaluation in the context of the working object to origin file\n"
				 "saveelementas <JSONPath>\n<file>\n"
				 " -saves result of <JSONPath> evaluation in the context of the working object to <file>\n"
				 "saveselected\n"
				 " -saves selected object to origin file\n"
				 "saveselectedas <file>\n"
				 " -saves selected object to <file>\n"
				 "select <key>\n"
				 ...
				 "selectedasworking\n"
				 " -sets selected object as working object\n"
				 "reset\n"
				 " -sets file object as working object\n"
				 "help\n"
